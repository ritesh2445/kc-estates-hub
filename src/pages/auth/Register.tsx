...
export default function Register() {
  ...
  return (
    <>
      <Helmet>
        <title>Create Account | KC Associates</title>
        <meta name="description" content="Create your KC Associates account to save properties, book visits, and more." />
      </Helmet>
        ...
        <div className="hidden lg:block lg:w-1/2 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="text-center text-primary-foreground">
              <h2 className="text-3xl font-bold mb-4">Join KC Associates</h2>
              <p className="text-primary-foreground/80 max-w-md">
                Create an account to save properties, schedule visits, and get personalized recommendations.
              </p>
            </div>
          </div>
        </div>
